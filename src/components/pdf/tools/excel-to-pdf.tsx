...
import { excelToPdf } from '@/lib/pdf/from-excel';
import { CheckCircleIcon, FileIcon, FileSpreadsheetIcon } from 'lucide-react';
...
export function ExcelToPdfTool() {
  ...
  const handleConvert = async () => {
    ...
    try {
      const pdfBytes = await excelToPdf(file.buffer);
